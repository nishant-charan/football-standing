...
public class StandingService {
    ...
    public List<StandingDto> getStandings(String leagueId) {
        ...
        String response = footballService.getDataFromService(GET_STANDINGS_ACTION, LEAGUE_ID_PARAM, leagueId);
        try {
            if (response.contains(ERROR)) {
                ...
                standings = Arrays.asList(objectMapper.readValue(response, StandingDto[].class));
            }
